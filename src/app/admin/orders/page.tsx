...
import { getOrders, updateOrderStatus, deleteOrder } from "@/app/_actions/orders"
            ...
            return (
              <TableRow key={order.id}>
                ...
                <TableCell>
                  ...
                  <span className="text-sm text-gray-500">{shippingInfo.phoneNumber}</span>
                </TableCell>
              ...
              <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">{formatCurrency(selectedOrder.price)}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    {(() => {
                      const shipping = JSON.parse(selectedOrder.shippingDetails || '{}')
                      return (
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">{shipping.phoneNumber}</span>
                          </div>
                          <div className="flex justify-between">
                      ...
                      return (
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-right">{shipping.streetAddress}</span>
                          </div>
                          <div className="flex justify-between">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">{shipping.province}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-gray-600">Quantity:</span>
                            <span className="font-medium">{shipping.quantity}</span>
                          </div>
                        </div>
                      )
                    })()}
