...
const slides: Slide[] = [
  {
    ...
    description:
      "Discover our curated collection of high-end kitchen appliances designed for modern homes.",
    link: "/products",
    tag: "New Arrivals",
  },
  {
    ...
    description:
      "Limited time offers on our most popular home and kitchen appliances. Don't miss out!",
    link: "/products",
    tag: "Special Offer",
  },
  {
    ...
    description:
      "Organize your kitchen with our premium collection of storage solutions.",
    link: "/products",
    tag: "Featured",
  },
];
